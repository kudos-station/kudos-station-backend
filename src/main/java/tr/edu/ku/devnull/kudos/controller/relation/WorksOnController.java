...
public class WorksOnController {
    ...
    public ResponseEntity<?> insertToWorksOnTest(@PathVariable("user-id") Integer userID,
        ...
        if (!worksOnService.insertToWorksOnTest(userID, departmentID, projectID, workHours)) {
            return ResponseEntity.badRequest().body(HttpStatus.BAD_REQUEST);
        }
